...
<?php 
    $gId = $_GET['id'];
    $resultdata = $con->query("SELECT * from `tbl_gallery` where galleryId = '$gId'");
    $result = array();
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-ml-8 col-mdl-4 col-sm-6 mt-5">
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert" id="successmessage" style="display:none">
                                You had <strong>Successfully Edit</strong>Gallery for Website.
                                    ...
                                    <div class="pricing-list">
                                        ...
                                        <div class="prc-list text-left">
                                            ...
                                            <?php foreach($result as $value) { ?>                  
                                                    <input type='hidden' value='<?php echo $value['galleryId']?>' name='galleryId'>    
                                                <div class="row">
                                                    <div class="col-md-4">
