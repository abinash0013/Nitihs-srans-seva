                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="add.php"><button type="button" class="btn btn-primary float-right mb-4">Add Gallery</button></a>
                                </div>                                    
                            </div>
                                        ...
                                        <?php foreach($result as $value){?>
                                            <form action="#" method="post">
                                                <tr>                                                   
                                                    ...
                                                    <td>
                                                        <a href="edit.php?id=<?php echo $value['galleryId']; ?> &Q=<?php echo $value['galleryId']?>"><button type="button" class="btn btn-primary"><i class="ti-pencil"></i></button></a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-danger" onclick="deletefun(<?php echo $value['galleryId'];?>)">Delete</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div-->
