...
<!-- :::::::::::::::::::::::::::::::::::> Fetch Data Start <::::::::::::::::::::::::::::::::::: -->
<?php 
    $resultdata = $con->query("SELECT * from `tbl_donation` order by donationId desc");
    $result = array();
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <h4 class="header-title">Donation</h4>
                                </div>
                                <!-- <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <?php foreach($result as $value){?>
                                            <form action="#" method="post">
                                                <tr>                                                   
                                                    ...
                                                    <td>
                                                        <a href="edit.php?id=<?php echo $value['donationId']; ?> &Q=<?php echo $value['donationId']?>"><span class="status-p bg-info"><i class="ti-pencil"></i></span></a>
                                                    </td>
                                                </tr>
                                            </form>
                                        <?php } ?>
