...
<?php 
    $aId = $_GET['id'];
    $resultdata = $con->query("SELECT * from `tbl_activity` where activityId = '$aId'");
    $result = array();
                                    ...
                                    <div class="pricing-list">
                                        ...
                                        <div class="prc-list text-left">
                                            ...
                                            <?php foreach($result as $value) { ?>
                                                <input type="hidden" name="activityId" value="<?php echo $value['activityId'];?>"/>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" value="<?php echo $value['title']; ?>" id="title" name="title">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="col font-weight-bold">
                                                            <textarea class="form-control" aria-label="With textarea" id="description" name="description"><?php echo $value['description']; ?></textarea>
                                                        </div><br/>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="col font-weight-bold">
                                                            <input type="date" class="form-control form-control-sm myform" value="<?php echo $value['date']; ?>" id="date" name="date">
                                                        </div>
                                                    </div>
