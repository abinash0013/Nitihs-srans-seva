...
<?php 
    $tId = $_GET['id'];
    $resultdata = $con->query("SELECT * from `tbl_team` where teamId = '$tId'");
    $result = array();
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-ml-8 col-mdl-4 col-sm-6 mt-5">
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert" id="successmessage" style="display:none">
                                You had <strong>Successfully Edit</strong>a Team Member for Website.
                                    ...
                                    <div class="pricing-list">
                                        ...
                                        <div class="prc-list text-left">
                                            ...
                                            <?php foreach($result as $value) { ?>                    
                                                <input type='hidden' value='<?php echo $value['teamId']?>' name='teamId'>     
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" value="<?php echo $value['name']; ?>" id="name" name="name">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" value="<?php echo $value['position']; ?>" id="position" name="position">
                                                        </div>
                                                    </div>
