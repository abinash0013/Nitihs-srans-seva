...
<?php 
        $aId = $_GET['id'];
    $resultdata = $con->query("SELECT * from `tbl_about` where aboutId = '$aId'");
    $result = array();
                                    ...
                                    <div class="pricing-list">
                                        ...
                                        <div class="prc-list text-left">
                                            ...
                                            <?php foreach($result as $value) { ?>
                                                <input type="hidden" class="form-control form-control-sm myform" value="<?php echo $value['aboutId']; ?>" id="aboutId" name="aboutId">
                                                <div class="row">
                                                    <div class="col-md-4">
